        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <h3 class="text-white"><i class="fa fa-file-circle-plus text-white me-1"></i> Form Tambah Berita</h3>
                    <p class="text-subtitle">Buat konten berita yang menarik dan informatif</p>
                </div>
                <div class="col-12 col-md-6">
                    ...
                    <div class="card modern-card">
                        <div class="card-header modern-card-header mb-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="card-title"><i class="fa fa-circle-plus"></i> Form Input Berita</h4>
                            ...
                            <form action="{{ Route('berita.store') }}" method="POST" enctype="multipart/form-data" id="newsForm">
                                ...
                                <div class="modern-form-group">
                                    ...
                                    <div class="form-floating-effect">
                                        <input type="text" name="judul" class="form-control modern-form-control" id="judul" placeholder=" " required />
                                ...
                                <div class="modern-form-group">
                                    ...
                                    <textarea name="konten" class="form-control modern-form-control" id="konten" rows="6" placeholder="Tulis konten berita yang informatif dan menarik..." required></textarea>
                                    @error('konten')
                                        <small class="error-message">{{ $message }}</small>
                                    @enderror
                                </div>
