                    ...
                    <div class="card-body">
                        <form action="{{ Route('berita.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-control" id="basicInput" placeholder="isi nama kategori" />
                                @error('nama')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="konten" class="form-control" id="basicInput" placeholder="isi nama kategori" />
                                @error('konten')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" name="waktu" class="form-control" id="basicInput" placeholder="isi nama kategori" />
                                @error('waktu')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
