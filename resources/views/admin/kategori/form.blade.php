        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <h3 class="text-white"><i class="fa fa-file-circle-plus text-white me-1"></i> Form Tambah Kategori</h3>
                    <p class="text-subtitle">Buat kategori baru untuk mengorganisir konten</p>
                </div>
                <div class="col-12 col-md-6">
                    ...
                    <div class="card modern-card">
                        <div class="card-header modern-card-header mb-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="card-title"><i class="fa fa-circle-plus"></i> Form Input Kategori</h4>
                            ...
                            <form action="{{ Route('kategori.store') }}" method="POST" id="categoryForm">
                                ...
                                <div class="modern-form-group">
                                    ...
                                    <div class="form-floating-effect">
                                        <input type="text" name="nama" class="form-control modern-form-control" id="nama" placeholder=" " required />
                                        <label for="nama" class="floating-label">Masukkan nama kategori...</label>
                                    </div>
                                    @error('nama')
